...
Rem IF /I '%SILENT_INSTALL%'=='TRUE' (
Rem  IF EXIST %INSTALL_DIR%\"Windows NT" SET DESROOT=%INSTALL_DIR%
Rem  IF EXIST %INSTALL_DIR1%\"Windows NT" SET DESROOT=%INSTALL_DIR1%
Rem  IF EXIST %INSTALL_DIR2%\"Windows NT" SET DESROOT=%INSTALL_DIR2%
Rem ) 
...
IF /I '%VerType%'=='DevCopy' (
   ...
   IF EXIST %DESROOT%\%Executable% (
      ...
      %DESROOT%\%VerType%\%ACLUni%.exe /s /a /x /s /v"/qb /passive /quiet /l* \"%INSTALL_DIR%\%VerType%\%Version%\Uninstallation.log\""
      %DESROOT%\%VerType%\%ACLNonUni%.exe /s /a /x /s /v"/qb /passive /quiet /l* \"%INSTALL_DIR%\%VerType%\%Version%\Uninstallation.log\""
   ...
   IF NOT EXIST %DESROOT%\%Executable% (
      ...
      IF /I '%TEST_UNICODE%'=='Yes' %DESROOT%\%VerType%\%ACLUni%.exe /s /a /s /v"/qb /passive /quiet PIDKEY=CAW1234567890 COMPANYNAME=\"ACLQA Automation\" INSTALLDIR=\"%INSTALL_DIR%\" /l* \"%INSTALL_DIR%\%VerType%\%Version%\Installation.log\""
      IF /I '%TEST_NONUNICODE%'=='Yes' %DESROOT%\%VerType%\%ACLNonUni%.exe /s /a /s /v"/qb /passive /quiet PIDKEY=CAW1234567890 COMPANYNAME=\"ACLQA Automation\" INSTALLDIR=\"%INSTALL_DIR%\" /l* \"%INSTALL_DIR%\%VerType%\%Version%\Installation.log\""
