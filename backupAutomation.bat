...
SET SRCROOT=D:\ACL\TFSView\RFT_Automation\QA_Automation_2012_V2.0_I18N
...
SET TOUSER=%UPLOADTO2% Steven2 Danny Iryna Yousef Kwok Jun Maya Nahid
...
If /I '%UPDATE_PROJECT%'=='TRUE' (
   ...
   XCOPY %FD1%* %DESROOT%.\..\SharedAutomationTestData\ACLProject\ %XCSCWITCH%
   )
