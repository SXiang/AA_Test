...
:INSTALLER
  ...
  SET ACLNonUni=ACLv93%LOCALE%_Desktop_NonUnicode
  SET ACLUni=ACLv93%LOCALE%_Desktop_Unicode
  IF /I '%LOCALE%'=='ZH' (
    SET ACLNonUni=ACLv93%Ch_Desktop_NonUnicode
    SET ACLUni=ACLv93Ch_Desktop_Unicode
	) ELSE (
	   SET ACLNonUni=ACLv93%LOCALE%_Desktop_NonUnicode
       SET ACLUni=ACLv93%LOCALE%_Desktop_Unicode
	)
