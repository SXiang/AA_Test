...
public class GenKeywordDoc {
	...
	public static void main(String args[])
	{
		...
		for (String curProj : projects) {
			...
			String keywordFolderFullPath = System.getProperty("user.dir") + "/AX_" + PROJECT + "/Tasks";
			String keywordsDefWikiFile = System.getProperty("user.dir") + "/doc/WikiPages" + "/AX_" + PROJECT + "/AX_" + PROJECT + "_keywords_Definitions.txt";
