...
import resources.lib.acl.tool.convertCsvToXlsHelper;

/**
 * Description   : Functional Test Script
 * @author steven_xiang
 */
public class convertCsvToXls extends convertCsvToXlsHelper
{
	/**
...
//	String csvFileOrDir = "AX_Addins/KeywordTable/SmokeTest";
	...
	private void convertCsv(String csvFileOrDir){
		String xlsName="";
		String csvName=csvFileOrDir;

		File csvFile = new File(csvFileOrDir); 
		if(csvFile.isFile()){ //Single file conversion		
			...
			for (String csvFileName: csvFile.list(new lib.acl.tool.wikiConvert.FileFilter("csv"))) {				
