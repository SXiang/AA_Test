...
IF '%ScriptDir%'=='' SET ScriptDir=%RFT_PROJECT_LOCATION%\lib\acl\tool\jenkins
...
IF NOT '%BUIDE%'=='' (
	       ...
	       CALL %RUN_PROJECT_LOCATION%\runRFT.bat %RFT_PROJECT_LOCATION% %RFT_SCRIPT_NAME% %BUIDE% %isUnicode% %EMAIL_REPORT% "OOOOO%RUN_PROJECT_LOCATION% CDOMessage.exe %Subject%,%EmailParameters%OOOOO" %TEST_CATEGORY% %SILENT%
		   CALL :SEND_MAIL
		   )
GOTO :EOF
