...
IF NOT '%BUIDE%'=='' (
	       ...
	       START "Run auto test... " /D%RUN_PROJECT_LOCATION% /WAIT /B runRFT.bat %RFT_PROJECT_LOCATION% %RFT_SCRIPT_NAME% %BUIDE% %isUnicode% %EMAIL_REPORT% "OOOOO%RUN_PROJECT_LOCATION% CDOMessage.exe %Subject%,%EmailParameters%OOOOO" %TEST_CATEGORY% %SILENT% 
		   CALL :SEND_MAIL
		   )
GOTO :EOF
