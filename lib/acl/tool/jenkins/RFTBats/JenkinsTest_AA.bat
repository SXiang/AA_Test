...
SET redir=%reportDir%\%Version%-%WHICH%
...
REM CALL %ScriptDirTest%\JenkinsTest.bat %USER_NAME% %PASSWORD% %DOMAIN_NAME% %TEST_BUILD% %TEST_UNICODE% %TEST_NONUNICODE% %TEST_CATEGORY% %PROJECT_TYPE% %tFolder%
...
REM TYPE %reportDir%\test_details.log
...
GOTO EOF
:Skip
Echo This build had been tested on this machine: %Version%-%WHICH%
GOTO EOF
:EOF
EXIT 0
EXIT 0
