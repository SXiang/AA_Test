 ...
 * @since  June 11, 2010
 */
public class UnicodeUtil extends RationalTestScript
{
	...
	public static String setPoolLanguageIndex(String poolFile){
		...
		name = new File(poolFile).getName().replace(".xls", "").replace(".XLS","").replace(".csv","").replace(".CSV", "");
...
//			System.out.println("Your excel file has been generated");
	...
	public static String XlsToCsv(String xlsName, String csvName){
	    ...
	    {
	      //File to Get data in form of CSV
		  csvName = csvName.replaceAll(".csv", ++numCsv+".csv");
	      File cf = new File(csvName);
