...
import resources.ACL_Desktop.Tasks.Analyze.Statistical.profileHelper;
...
public class profile extends profileHelper
{
	 ...
	 * Generated     : <b>Mar 24, 2012 3:42:14 PM</b>
  ...
  //
	...
	public boolean dataInitialization() {
		...
		defaultMenu = "Analyze";
		command = "Statistical->Profile";
		winTitle = "Profile Fields";
		tabMainName = "Profile"; //"_Main";
		fileExt = ".TXT";
	...
	public void thisMainTab(GuiSubitemTestObject tabDialog){
		...
		String keyToExp = "Profile Fields...";
