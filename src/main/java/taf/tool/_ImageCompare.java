...
/**
 * Script Name   : <b>IC.java</b>
 * Generated     : <b>11:30:14 AM</b> 
...
import com.sun.image.codec.jpeg.*;
 //http://mindmeat.blogspot.ca/2008/11/java-image-comparison.html
 //http://mindmeat.blogspot.com/2008/07/java-image-comparison.html
 public class _ImageCompare {
	...
	public static void main(String[] args) {
		...
		String testTemp="C:\\ACL\\Automation\\imageTest\\";
		_ImageCompare ic = new _ImageCompare(testTemp+"errorSnapshot_16.jpeg", testTemp+"errorSnapshot_17.jpeg");
		//_ImageCompare ic = new _ImageCompare(testTemp+"test1.jpg", testTemp+"test2.jpg");
		// Set the comparison parameters. 
		//   (num vertical regions, num horizontal regions, sensitivity, stabilizer)
		ic.setParameters(8, 6, 0, 30);
		...
		if (!ic.match()) {
			saveJPG(ic.getChangeIndicator(), testTemp+"changes.jpg");
		}
	}
	
	// constructor 1. use filenames
	public _ImageCompare(String file1, String file2) {
		this(loadJPG(file1), loadJPG(file2));
	}
 
	// constructor 2. use awt images.
	public _ImageCompare(Image img1, Image img2) {
	...
	public _ImageCompare(BufferedImage img1, BufferedImage img2) {
		this.img1 = img1;
		this.img2 = img2;
		autoSetParameters();
	}
	...
	public void compare() {
		...
		// convert to gray images. -- grayscale image, and brightening the pixels in the image.
