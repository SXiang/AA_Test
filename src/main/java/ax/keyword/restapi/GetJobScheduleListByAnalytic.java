...
public class GetJobScheduleListByAnalytic extends RestapiHelper implements KeywordInterface {
	/**
	...
	protected String dpCount;   	    //@arg value for Count - number of records restricted
