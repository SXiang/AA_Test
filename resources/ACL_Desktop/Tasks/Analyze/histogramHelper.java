 ...
 * Generated     : <b>2012/03/29 7:11:01 PM</b><br>
 ...
 * @author Steven_Xiang
 */
public abstract class histogramHelper extends ACL_Desktop.AppObject.DesktopSuperHelper
{
	/**
	 * Histogram: with default state.
	 *		.text : Histogram
	 * 		.class : #32770
	...
	/**
	 * Histogram: with specific test context and state.
	 *		.text : Histogram
	 * 		.class : #32770
	 * 		.processName : ACLWin.exe
	 * 		.name : Histogram
	...
	{
		setScriptName("ACL_Desktop.Tasks.Analyze.histogram");
	}
