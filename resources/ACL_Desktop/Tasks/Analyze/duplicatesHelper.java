 ...
 * Generated     : <b>2012/03/29 7:23:41 PM</b><br>
 ...
 * @author Steven_Xiang
 */
public abstract class duplicatesHelper extends ACL_Desktop.AppObject.DesktopSuperHelper
{
	/**
	 * Duplicates: with default state.
	 *		.text : Duplicates
	 * 		.class : #32770
	...
	/**
	 * Duplicates: with specific test context and state.
	 *		.text : Duplicates
	 * 		.class : #32770
	 * 		.processName : ACLWin.exe
	 * 		.name : Duplicates
	...
	{
		setScriptName("ACL_Desktop.Tasks.Analyze.duplicates");
	}
