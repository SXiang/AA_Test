 ...
 * Generated     : <b>2012/04/03 5:33:29 PM</b><br>
 ...
 * @author Steven_Xiang
 */
public abstract class sequenceHelper extends ACL_Desktop.AppObject.DesktopSuperHelper
{
	/**
	 * Sequence: with default state.
	 *		.text : Sequence
	 * 		.class : #32770
	...
	/**
	 * Sequence: with specific test context and state.
	 *		.text : Sequence
	 * 		.class : #32770
	 * 		.processName : ACLWin.exe
	 * 		.name : Sequence
	...
	{
		setScriptName("ACL_Desktop.Tasks.Analyze.sequence");
	}
