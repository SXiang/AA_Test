 ...
 * Generated     : <b>2012/03/29 7:22:09 PM</b><br>
 ...
 * @author Steven_Xiang
 */
public abstract class gapsHelper extends ACL_Desktop.AppObject.DesktopSuperHelper
{
	/**
	 * Gaps: with default state.
	 *		.text : Gaps
	 * 		.class : #32770
	...
	/**
	 * Gaps: with specific test context and state.
	 *		.text : Gaps
	 * 		.class : #32770
	 * 		.processName : ACLWin.exe
	 * 		.name : Gaps
	...
	{
		setScriptName("ACL_Desktop.Tasks.Analyze.gaps");
	}
