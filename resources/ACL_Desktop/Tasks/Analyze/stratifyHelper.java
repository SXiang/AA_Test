 ...
 * Generated     : <b>2012/03/28 3:40:41 PM</b><br>
 ...
 * @author Steven_Xiang
 */
public abstract class stratifyHelper extends ACL_Desktop.AppObject.DesktopSuperHelper
{
	/**
	 * Stratify: with default state.
	 *		.text : Stratify
	 * 		.class : #32770
	...
	/**
	 * Stratify: with specific test context and state.
	 *		.text : Stratify
	 * 		.class : #32770
	 * 		.processName : ACLWin.exe
	 * 		.name : Stratify
	...
	{
		setScriptName("ACL_Desktop.Tasks.Analyze.stratify");
	}
